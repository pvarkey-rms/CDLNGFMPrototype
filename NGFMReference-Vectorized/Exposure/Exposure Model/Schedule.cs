...
namespace NGFMReference
{
    ...
    {      
        ...
        public virtual void AddItemList(HashSet<T> listitems)
        {
            foreach (T element in listitems)
            {
                AddItem(element);
            }
        }
    ...
    {       
        ...
        //public float Factor
        //{
        //    get { return ScheduleList.First().Factor; }
            
        //}
        //public int FactorIndex
        //{
        //    get { return ScheduleList.First().FactorIndex; }
        ...
        public int ActNumOfBldgs
        {
            ...
            {
                if (IsLocation)
                    return ScheduleList.First().ActNumOfSampleBldgs;
                else
                    return 1;
            }
        }
        public int NumOfBldgs
        {
            ...
            {
                if (IsLocation)
                    return ScheduleList.First().NumOfTrueBldgs;
                else
                    return 1;
            }
        }

        public double[] MultiplierArr
        {
            get
            {
                if (IsLocation)
    ...
    public class ScheduleOfContracts : Schedule<GraphInfo>
    {
        ...
        public ScheduleOfContracts(string _name, HashSet<GraphInfo> contracts)
            : base(_name, contracts) 
        {
            //positionType = _pType;
        }

        public override void AddItem(GraphInfo Item)
        {
            ScheduleList.Add(Item);
        }
    }
