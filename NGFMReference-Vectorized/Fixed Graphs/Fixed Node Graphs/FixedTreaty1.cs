...
namespace NGFMReference
{
    public class FixedTreaty1 : TreatyGraph
    {
        ...
        public override void Initialize()
        {
            ...
            GraphInfo overlapGraph;
            cache.GetGraphInfo(11331, out overlapGraph);
            GraphInfo normalGraph;
            cache.GetGraphInfo(11324656, out normalGraph);

            ScheduleOfContracts schedule = new ScheduleOfContracts("PositionA_Gross",
                                                                    new HashSet<GraphInfo>() { overlapGraph, normalGraph });
