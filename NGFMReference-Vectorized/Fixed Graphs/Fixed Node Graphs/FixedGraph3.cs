    ...
    public class FixedGraph3 : FixedPrimaryGraph
    {
        ...
        public override void Initialize()
        {
           ...
           //_graphNodes.Add(Node01);
            ...
            Cover topCover = new Cover("TreatyCover", false, new MonetaryValue(600.0), new MonetaryValue(1000000.0), new PercentValue(100), false, TimeBasis.Occurrence, TimeBasis.Occurrence, TermValueType.Numeric, 0, true);
