...
{
    public class TreatyGraph : GraphOfNodes
    {
        protected Dictionary<long, Declarations> declarationsForAssociatedContracts;

        public override Dictionary<long, Declarations> DeclarationsForAssociatedContracts
        { get 
            {
                return declarationsForAssociatedContracts;    
            } 
        }
        ...
        public override void BuildAtomicRITEs()
        {
            ...
            atomicCoverageRITEs = GetCoverageRITEs();
        }
        ...
        public override HashSet<CoverageAtomicRITE> GetCoverageRITEs()
        {
            ...
            foreach (ContractAtomicRITE contractRITE in _contractRITEs)
            {
                ...
                coverageRITEs.UnionWith(contractRITE.contractGraph.Graph.GetCoverageRITEs());
            }
