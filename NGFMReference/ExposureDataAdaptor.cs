...
namespace NGFMReference
{
    public class ExposureDataAdaptor
    {
        ...
        private RITCharacteristic BuildRITCharacteristic(KeyValuePair<long, RiskItemCharacteristicIDAttributes> RiteAttribute)
        {
            return new RITCharacteristic(RiteAttribute.Key, (ExposureType)RiteAttribute.Value.ExposureType, RiteAttribute.Value.Value);
        }

        private RITE BuildRITE(KeyValuePair<long, RiskItemCharacteristicIDAttributes> RiteAttribute)
        {
